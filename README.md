...
- Реализована валидация формы создания продукта, чтобы проверять отсутствие запрещенных слов.
...
- Добавлена валидация для поля загрузки изображения, которая проверяет формат и размер загружаемого файла (загружаемые файлы имеют формат JPEG или PNG и не превышают размер 5 МБ.)
---
#### Установка:
